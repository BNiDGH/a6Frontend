...
const mockVenues = [
  { name: 'The Bloom Pavilion', imgSrc: '/img/bloom.jpg' },
  { name: 'Spark Space', imgSrc: '/img/sparkspace.jpg' },
  { name: 'The Grand Table', imgSrc: '/img/grandtable.jpg' },
];
type RatingAction = 
...
export default function CardPanel() {
  ...
  return (
    <div className="max-w-6xl mx-auto my-10 p-4">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-60 mb-10 w-full justify-items-center">
